...
@javax.annotation.Generated(
    ...
    comments = "Source: vector_contract.proto")
...
public final class VectorSearchServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hybrid.vector.contract.VectorSearchRequest,
      com.hybrid.vector.contract.VectorSearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Search",
      requestType = com.hybrid.vector.contract.VectorSearchRequest.class,
      responseType = com.hybrid.vector.contract.VectorSearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hybrid.vector.contract.VectorSearchRequest,
      com.hybrid.vector.contract.VectorSearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<com.hybrid.vector.contract.VectorSearchRequest, com.hybrid.vector.contract.VectorSearchResponse> getSearchMethod;
      ...
      synchronized (VectorSearchServiceGrpc.class) {
        if ((getSearchMethod = VectorSearchServiceGrpc.getSearchMethod) == null) {
          VectorSearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<com.hybrid.vector.contract.VectorSearchRequest, com.hybrid.vector.contract.VectorSearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hybrid.vector.contract.VectorSearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hybrid.vector.contract.VectorSearchResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void search(com.hybrid.vector.contract.VectorSearchRequest request,
        io.grpc.stub.StreamObserver<com.hybrid.vector.contract.VectorSearchResponse> responseObserver) {
  ...
  public static final class VectorSearchServiceStub
    ...
    /**
     */
    public void search(com.hybrid.vector.contract.VectorSearchRequest request,
        io.grpc.stub.StreamObserver<com.hybrid.vector.contract.VectorSearchResponse> responseObserver) {
  ...
  public static final class VectorSearchServiceBlockingStub
    ...
    /**
     */
    public com.hybrid.vector.contract.VectorSearchResponse search(com.hybrid.vector.contract.VectorSearchRequest request) {
  ...
  public static final class VectorSearchServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hybrid.vector.contract.VectorSearchResponse> search(
        com.hybrid.vector.contract.VectorSearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((com.hybrid.vector.contract.VectorSearchRequest) request,
              (io.grpc.stub.StreamObserver<com.hybrid.vector.contract.VectorSearchResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.hybrid.vector.contract.VectorSearchRequest,
              com.hybrid.vector.contract.VectorSearchResponse>(
  ...
  private static abstract class VectorSearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hybrid.vector.contract.VectorContractProto.getDescriptor();
    }
